...
Route::get('/estoque/adicionar', [EstoqueController::class,  //GET mostra o formulario  
    'adicionar'])->name('estoque.adicionar');

Route::post('/estoque/adicionar', [EstoqueController::class,  //POST envia o formulario
    'adicionar']);
